function [STATISTICS3,FD3,TD3,AD3]=LEACHec(IniEng,NetSize,NoOfNode,NoOfRound,cluster_head_percentage)
    ...
    for i=1:1:n
        if(S(i).E>0)
            ...
            if ( (S(i).G)<=0)  
                ...
                %if(temp_rand<= (p/(1-p*mod(r,round(1/p))))*(tan((Eo-S(i).E)/Eo))) %%Improvement2
